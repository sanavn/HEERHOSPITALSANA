...
<head>
    ...
    <meta charset="utf-8">
    <title>All Doctor - <?php echo $application_name; ?></title>
...
<body class="tables-datatables-page">
    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <!-- Start: Topbar -->
            <?php $breadcrumb = array('bk1' => '', 'bk1_url' => '', 'bk2' => 'Doctor List'); ?>
                        ...
                        <div class="panel panel-visible panel-dark">
                            <div class="panel-heading">
                                <span class="panel-title">
                                    <span class="fa fa-user"></span>Doctor List
                                </span>
                                <div class="widget-menu pull-right mr10">
                                    <div class="btn-group">
                                        <a href="dr-add.php" class="btn btn-xs btn-default">
                                            <span class="glyphicons glyphicons-circle_plus fs11 mr10"></span> Add Doctor
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body pn">
                                <table class="table table-striped table-bordered table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                    	<?php 
                                        $result = $con->select_query("doctor","*","order by id desc","");
                                        $i = 1;
                                        while($row = mysqli_fetch_array($result))
                                        {

                                            $result2 = $con->select_query("doctor","*","where id = '".$row['id']."' ","");
                                        ...
                                        <tr>
                                            ...
                                            <td class="" style="text-align: center">                                            	
                                                <div class="btn-group">
                                                <a href="dr-update.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-xs dark" title="Update"><i class="glyphicons glyphicons-pencil"></i></a>
