...
<head>
    ...
    <meta charset="utf-8">
    <title>All Gallery - <?php echo $application_name; ?></title>
...
<body class="tables-datatables-page">
    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <!-- Start: Topbar -->
            <?php $breadcrumb = array('bk1' => '', 'bk1_url' => '', 'bk2' => 'Gallery'); ?>
                        ...
                        <div class="panel panel-visible panel-dark">
                            <div class="panel-heading">
                                <span class="panel-title">
                                    <span class="fa fa-user"></span>Gallery
                                </span>
                                <div class="widget-menu pull-right mr10">
                                    <div class="btn-group">
                                        <a href="gallery-add.php" class="btn btn-xs btn-default">
                                            <span class="glyphicons glyphicons-circle_plus fs11 mr10"></span> Add Gallery
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body pn">
                                <table class="table table-striped table-bordered table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td ><?php echo $i; ?></td>
                                            <td><img src="../gallery/<?php echo $row['image']; ?>" style="width: 50px;    height: 50px;"></td>
                                            <td class="" style="text-align: center">                                            	
                                                <div class="btn-group">
                                                <a href="gallery-update.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-xs dark" title="Update"><i class="glyphicons glyphicons-pencil"></i></a>
