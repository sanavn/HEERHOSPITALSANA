...
if(isset($_GET['id']))
{
    ...
    $result = $con->select_query("gallery","*","WHERE id = '".$id."'","");
    if($result)
    {
        ...
        {
			$_SESSION['msg']['users_error'] = "Gallery Does't found";
...
if(isset($_POST['save']))
{
        ...
        { 
            ...
            $target = "../gallery/".basename($imgname);
            ...
            if (move_uploaded_file($_FILES["image"]["tmp_name"], $target)) 
            {
                ...
                $result = $con->update("gallery",$gallery_array,"where id = '".$_GET['id']."'");
                // die;
                if($result)
                {
	...
	header("location:gallery-update.php?id=".$user_id);
	exit;
}
...
<head>
    ...
    <meta charset="utf-8">
    <title>Gallery Update - <?php echo $application_name; ?></title>
...
<body class="tables-formatted-page sb-l-o sb-r-c">
    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <!-- Start: Topbar -->
            <?php $breadcrumb = array('bk1' => 'Gallery', 'bk1_url' => 'gallery-view.php', 'bk2' => 'Gallery Update', 'bk2_url' => $full_url); ?>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-dark">
                            <div class="panel-heading">
                                <span class="fa fa-user"></span> <span class="panel-title">Gallery Update</span>
                            </div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <img src="../gallery/<?php echo $old_image; ?>" style="
